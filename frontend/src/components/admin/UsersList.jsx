        ...
        <div className="overflow-x-auto">
          <table className="lg:w-2/4 sm:w-2/4 mx-auto bg-background text-text dark:bg-background-dark dark:text-text-dark shadow-2xl rounded-lg">
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user._id}>
                  <td className="py-2 px-4 text-primary dark:text-primary-dark">{user._id}</td>
                  <td className="py-2 px-4">{user.name}</td>
                  <td className="py-2 px-4">{user.email}</td>
                  {/* <td className="py-2 px-4">{user.role}</td> */}
                  <td className="py-2 px-4">
                    <button
                      className="bg-red-500 dark:bg-red-700 text-white px-4 py-2 m-2 rounded hover:bg-red-600 dark:hover:bg-red-800"
