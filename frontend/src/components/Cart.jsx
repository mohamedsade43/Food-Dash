              ...
              <form onSubmit={handleCheckout} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border bg-gray-100 dark:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-primary-dark"
                    required
                  />
                </div>
                <div>
                  <label htmlFor="street" className="block text-gray-700 dark:text-gray-300">Street address</label>
                  <input
                    type="text"
                    id="street"
                ...
                <div className="flex space-x-4">
                  <div className="w-1/2">
                    <label htmlFor="city" className="block text-gray-700 dark:text-gray-300">City</label>
                    <input
                      type="text"
                      id="city"
                      value={address.city}
