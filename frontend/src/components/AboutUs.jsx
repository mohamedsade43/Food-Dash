...
const AboutUs = () => {
  return (
    <>
      <Header />
      <div className="container mx-auto mt-2 p-4 lg:p-8 bg-background text-text dark:bg-background-dark dark:text-text-dark">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-700 leading-relaxed dark:text-gray-300">
